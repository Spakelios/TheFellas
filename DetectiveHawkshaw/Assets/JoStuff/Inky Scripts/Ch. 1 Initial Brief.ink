...
<I> Covered in clutter and dust. Its clearly not well maintained... </I>
...
<I> It appears to be full of clocks, old pocket watches, furniture and jewlerly. </I> 

{Char2("Katya_Happy")}{Icon("transparent")}
{Name("Katya")}"Look here Uncle Niki! Isn't it so pretty? I wish I could buy it for Mama-"
...
<I> She must be glad of the company if nothing else... </I>
...
{Icon("transparent")}
{Name("Nicolai")}
{MC("Margot")} {Char2("Nicolai_Think")} "So, To get straight to buisness, Mrs Weaver."
...
{Icon("EmilNeutral")}{Name("Emil")}<I> She began tearing up, clutching the long string of pearls that sat over her neck. </I>
 ...
 {Icon("transparent")}{Name("Margot")}"I could never trust those good for nothings down in the "Police"...not one bit!" 
...
{Name("Emil")}<I> A young constable barges in before we can do anything. Their shrill voice assualts our eardrums as she scowls at us.</I>
...
"Mrs Weaver has asked for our assitance and we shall do our uptmost to help her-"
...
"There so called "Detective Agency" is nothing but a hoax!"

{MC("Margot")}
{Char3("Charlotte")}
{Icon("transparent")}
{Name("Margot")}"Thats quite enough! Please ignore her dear, Work away!"
...
{MC("Nicolai_Think")}
{Icon("EmilUpset")}
{Name("Emil")} <I> If looks could kill, the young Miss Constable would have me 6 feet under.
